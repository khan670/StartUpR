          ...
          <div>
            ...
            <div className="relative -left-2">
              ...
              <a
                ...
                target="_blank"
                className="hover:bg-color-body p-2 inline-block rounded-full cursor-pointer transition-all hover:text-white text-color-text"
              >
                <LuGithub size={18} />
              </a>
              <a
                ...
                target="_blank"
                className="hover:bg-color-body p-2 cursor-pointer transition-all inline-block rounded-full hover:text-white text-color-text"
              >
